...
#define X_LINE_VERT1	(((0.0f+XMAX)-(0.0f+XMIN))/(3))+XMIN	/* coordinats x of second vertical line */
#define X_LINE_VERT2	(X_LINE_VERT1-XMIN)*2+XMIN				/* coordinats x of third vertical line */
